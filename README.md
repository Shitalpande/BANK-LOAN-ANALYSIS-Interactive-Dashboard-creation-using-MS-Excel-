...
2. Verified vs Non-Verified Status
- Verified: 59%
- Not Verified: 41%
This helps understand customer verification patterns.

3. Home Ownership vs Last Payment Date
A bar chart analyzing payment behavior of customers based on home ownership type such as Mortgage, Rent, Own, None, Other.

4. State-Wise Loan Status
A trend line chart showing loan distribution across different states, helping identify high vs low loan-activity regions.
